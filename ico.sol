...
contract CryptosICO is Cryptos{
    ...
    uint public saleStart = block.timestamp; // if sale need to start after an hour just add +3600
    uint public saleEnd = block.timestamp + 604800; // a week
    uint public tokenTradeStart = saleEnd + 604800; // after a week
